    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            NavHost(
                ...
                startDestination = Screen.TimerList.route
            ) {
                composable(route = Screen.TimerList.route) { navBackStackEntry ->
                    val viewModelFactory = HiltViewModelFactory(
                        context = LocalContext.current,
                        navBackStackEntry = navBackStackEntry
                    )
                    val viewModel: TimerListScreenViewModel = viewModel(
                        key = TimerListScreenViewModel.viewModelKey,
